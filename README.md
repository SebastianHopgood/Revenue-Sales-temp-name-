...
* ![BigQuery Raw Data Integration Proof]([data/raw_data_intergration_preview.png)](https://github.com/SebastianHopgood/Revenue-Sales-temp-name-/blob/main/data/raw_data_intergration_preview.png)
